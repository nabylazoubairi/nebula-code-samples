# Au Pair Society — Code Samples

A few Cloud Functions pulled from [Au Pair Society](https://github.com/nabylazoubairi/au-pair-society-portfolio), shared here to show actual code rather than just screenshots. Backend: Firebase (Firestore + Cloud Functions), Node.js.
